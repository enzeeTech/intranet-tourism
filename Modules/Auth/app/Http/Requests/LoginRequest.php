...
class LoginRequest extends FormRequest
{
    ...
    public function authenticate(): void
    {
        ...
        if (! auth()->attempt($this->only($this->authKey, 'password'), $this->boolean('remember'))) {
            ...
            throw ValidationException::withMessages([
                $this->authKey => trans('auth.failed'),
            ]);
        }

        // FIXME: should throw after login
        // abort_unless(auth()->user()->hasVerifiedEmail(), 422, 'Sila periksa emel untuk pengesahan emel.');
    ...
    public function ensureIsNotRateLimited(): void
    {
        ...
        throw ValidationException::withMessages([
            $this->authKey => trans('auth.throttle', [
                'seconds' => $seconds,

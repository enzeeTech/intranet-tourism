...
const Media = () => {
  ...
  const PautanHandleAddApp = () => {
    const isNameDuplicate = apps.some(app => app.label === newAppName);
    ...
    <Example>
      <>
        <section className="flex flex-col px-5 py-4 bg-white rounded-2xl shadow-custom max-w-[1500px] mx-8 my-10">
          ...
          <h2 className="mb-3 text-3xl font-bold text-blue-500">Album Name</h2>
            ...
            <Droppable droppableId="apps">
              {(provided) => (
                <table className="min-w-full divide-y divide-gray-200" {...provided.droppableProps} ref={provided.innerRef}>
                  <thead>
                    <tr>
                      <th className="border border-gray-300 px-20 max-md:px-2 py-3 font-bold text-md text-start text-black-500 label-column">Album Name</th>
                      <th className="border border-gray-300 w-1/12	 max-md:px-2 py-3 font-bold text-md text-start text-black-500 label-column">Delete</th> 
                    ...
                    <tr>
                        <td className='border border-gray-300'><input type="text" className="ml-2 p-2 border border-gray-300 rounded w-3/4" placeholder="Album #"></input></td>

                        <td className='border border-gray-300'><button className="focus:outline-none ml-2 bg-red-500 rounded-full p-2">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M6 2a1 1 0 00-1 1v1H3a1 1 0 100 2h1v10a2 2 0 002 2h8a2 2 0 002-2V6h1a1 1 0 100-2h-2V3a1 1 0 00-1-1H6zm3 3h2v10H9V5z" />
                            </svg>
                        </button></td>
                    </tr>
        ...
        {isAddModalVisible && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div className="relative px-8 py-6 bg-white rounded-2xl shadow-lg w-96">
              <h2 className="mb-4 text-xl font-bold">Create Album</h2>
              <input
                type="text"

...
const ProfileCard = ({ name, role, status, imageSrc, altText }) => (
  ...
  <div className="flex items-center bg-gray h-16 relative">
    <img loading="lazy" src={imageSrc} alt={altText} className="shrink-0 aspect-[0.97] w-[68px] rounded-full ml-10" />
    
    <img src={imageSrc} alt="Overlay Image" className="absolute h-5 w-5  left-20 mt-14 rounded-full" />
  </div>
...
const MyComponent = () => {
  ...
  const statusbutton = [
    { imageSrc: "https://cdn.builder.io/api/v1/image/assets/TEMP/b69229fef789e65ccbbd40f5084486249b34607e63cbed1fb5f8163bdb13848d?apiKey=d66b6c2c936f4300b407b67b0a5e8c4d&", altText: "Iskander Mirza's Portrait" },
  ]
...
{/* <section className=" flex flex-row gap-5  bg-slate-200 rounded-xl shadow-lg max-w-1920  max-md:flex-wrap max-md:pl-5 "> old style */}

  <header className="absolute text-4xl font-extrabold text-neutral-800 mt-10 mb-6 w-96 left-20">Who’s Online 
  <div className="font-extrabold text-neutral-800 mt-16 mb-6 border-b-2 border-neutral-300  "></div>

</header>



{/* <div class="container max-w-screen-md  bg-white px-10 py-10 rounded-xl  "> old style */}
<div class="container max-w-screen-lg bg-white  py-10 rounded-xl  mt-40 mb-40 items-start shadow-2xl">


      <div className="flex flex-col text-neutral-800  ">
        <header className="text-2xl font-extrabold text-neutral-800 ml-10">Online List</header>

        <div className="flex gap-5 mt-5 text-lg font-semibold  text-neutral-800 max-md:pr-5 ">

          <div className="relative flex items-center gap-1 ml-10">
            ...
            <div className={` w-3 h-3 bg-green-500 rounded-full border-2 border-white border-solid stroke-[2px] ${statusFilter !== "Online" && "opacity-0"}`} />
          </div>
          ...
          <div className="relative flex items-center gap-1">
            ...
            <div className={`shrink-0  w-3 h-3 bg-yellow-500 rounded-full border-2 border-white border-solid stroke-[2px]  ${statusFilter !== "Away" && "opacity-0"}`} />
          </div>
          ...
          <div className="relative flex items-center gap-1">
            ...
            <div className={`shrink-0 w-3 h-3 bg-red-500 rounded-full border-2 border-white border-solid stroke-[2px] ${statusFilter !== "Offline" && "opacity-0"}`} />
          </div>

              ...
              <ul>
                ...
                <div className="flex flex-row gap-2 mb-4 hover:bg-blue-100 items-center"  key={notification.id}>
                  ...
                  <div className="flex items-center bg-gray h-16">
                    ...
                    <img className="absolute h-5 w-5 left-20 mt-12 " src={notification.miniIcon} alt="" 
                  ...
                  <div className='flex flex-col w-100 h-50'>
                    <div className="block px-2 py-1 text-sm">{notification.users}</div>
                ...
                {/* <div>{notification.read ? (
                        ...
                        <img src="http://127.0.0.1:5173/public/assets/orangeball.png" alt="Unread" style={{ width: '10px', height: '10px', marginRight:'20px' }} />
                    )}</div>
                     */}

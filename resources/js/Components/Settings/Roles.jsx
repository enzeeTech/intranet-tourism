    ...
    return (
        <div className="px-4 sm:px-6 lg:px-8">
            <div className="sm:flex sm:items-center">
                <div className="mt-5 mr-2 file-search-bar-title">
                ...
                <div className="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                    <button
                        type="button"
                        className="block px-3 py-2 text-sm font-bold text-center text-white bg-indigo-600 rounded-md shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                    >
                        Assign as Admin
                    </button>
                </div>
            ...
            <div className="flow-root mt-8">
                <div className="-mx-4 -my-2 overflow-x-auto box-container sm:-mx-6 lg:-mx-8">
                        ...
                        <table className="min-w-full divide-y divide-gray-300">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900" style={{ width: "16rem" }}>
                                        Role
                                    </th>
                                </tr>
                            </thead>

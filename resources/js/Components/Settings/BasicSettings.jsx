  ...
  return (
    <section className="flex gap-2.5 mt-5 text-center">
      ...
      <button
        ...
        className="justify-center px-2 py-1.5 text-xs font-bold text-white bg-primary-500 rounded-3xl"
      >
        Choose file
      </button>
...
function LogoUploader() {
  ...
  return (
    <article className="flex flex-col px-5 py-4 bg-white rounded-xl shadow-custom max-w-[296px]">
      ...
      <button
        onClick={handleSave}
        className="self-center px-4 py-2 mt-5 text-white bg-primary-500 rounded-full"
      >
        Save
      </button>
      {savedImage && (

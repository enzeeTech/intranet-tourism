...
// function Navigation({ departmentID, userId }) {
//   const [activeTab, setActiveTab] = useState('Post'); // Default active tab set to 'Post'
//   const [polls, setPolls] = useState([]);
...
//       {activeTab === 'Post' && (
//         <div className="flex flex-col max-w-[900px] shadow-2xl pb-6 rounded-xl mt-6">
//           <div className="max-w-[875px] w-full border-inherit rounded-2xl shadow-2xl p-4 m-auto mt-6">
//             <ShareYourThoughts userId={userId} postType={`department_${departmentID}`} onCreatePoll={handleCreatePoll} />
//           </div>
//           <div className="max-w-[875px] w-full border-inherit rounded-2xl shadow-2xl p-4 m-auto mt-6">
//             <OutputData polls={polls} postType={`department_${departmentID}`} />
//           </div>
//         </div>
//       )}
//     </div>
...
// const AdminWall = ({ userId, departmentID }) => {
...
//         setDepartmentData({
//           departmentHeader: data.departmentName,
...
//         <HeaderSection
//           departmentID={departmentID}
//           departmentHeader={departmentData.departmentHeader}

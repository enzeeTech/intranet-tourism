...
function DpMembers() {
  return (
    <section className="flex flex-col px-6 pt-8 pb-20 bg-white rounded-3xl shadow-sm max-w-[875px] max-md:px-5">
      <div className="flex gap-3.5 text-base font-bold text-white max-md:flex-wrap max-md:max-w-full">
        <div className="justify-center items-start px-7 py-4 bg-gray-100 rounded-3xl text-neutral-800 text-opacity-30 max-md:px-5 max-md:max-w-full">
          Search Member
        </div>
        <button className="justify-center px-6 py-4 text-center whitespace-nowrap bg-blue-500 rounded-3xl max-md:px-5">
          Search
        </button>
        <button className="justify-center px-11 py-4 text-center whitespace-nowrap bg-red-500 rounded-3xl max-md:px-5">
          Invite
        </button>
      </div>
      ...
      <div className="flex gap-5 justify-between mt-10 max-md:flex-wrap max-md:max-w-full">
        <section className="flex flex-col">
          <div className="flex gap-5 whitespace-nowrap">
            ...
            <span className="flex-auto text-lg font-semibold text-stone-300">233</span>
          </div>
          <MemberCard 
      ...
      <div className="flex gap-5 mt-10 text-neutral-800 max-md:flex-wrap">
        <Avatar 
          ...
          alt="" 
          className="shrink-0 aspect-[0.98] w-[62px]" 
        />
        <div className="flex flex-col grow shrink-0 self-start mt-3 basis-0 w-fit max-md:max-w-full">
          <div className="flex gap-5 items-start text-xl font-bold max-md:flex-wrap max-md:max-w-full">
            <span className="flex-auto">Nur Shakilla Binti Ramli</span>
            <Avatar 
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/9218de473051084d78e5504ec5622a91b2b3c8cd4f35fa1adb2062037a1ad1c6?apiKey=d66b6c2c936f4300b407b67b0a5e8c4d&" 
              alt="" 
              className="shrink-0 mt-2 w-10 aspect-[1.47]" 
            />
          </div>
          <p className="mt-1 text-xs font-medium max-md:max-w-full">
            Pejabat Timbalan Ketua Pengarah (Promosi)
          </p>
        </div>
      </div>
    </section>

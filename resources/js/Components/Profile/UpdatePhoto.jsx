  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-50" onClick={handleCloseClick}>
      <div className="p-2 rounded-3xl w-4xl" onClick={(e) => e.stopPropagation()}>
        <section className="flex flex-col px-2.5 py-1 font-bold text-center bg-white rounded-xl shadow-custom w-[380px] rounded-3xl">
          ...
          <div className="flex flex-col pr-2.5 pl-2 w-full ">
            ...
            <div className="flex justify-center space-x-4 text-sm my-4">
              <button className="px-4 py-2 bg-white border-2 border-grey-300 hover:bg-gray-400 text-gray-400 hover:text-white rounded-full" onClick={handleCloseClick}>No</button>

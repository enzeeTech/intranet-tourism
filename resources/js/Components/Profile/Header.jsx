...
function ProfileHeader({ backgroundImage, profileImage, name, status, onEditBanner }) {
  ...
  return (
    <header
      className="flex overflow-hidden relative z-10 flex-col items-start px-7 pt-20 -mt-14 w-full h-auto max-md:px-5 max-md:max-w-half"
    ...
    >
      ...
      <div className="flex flex-col self-start px-9 -mt-16 -ml-10">

    ...
    <div className="staff-search-bar-container max-w-[1100px] p-4 bg-white rounded-2xl shadow-custom mb-5 sm:left">
      ...
      <div className="file-search-bar">
        ...
        {/* <button
          ...
          className="visit-department-btn text-md font-bold rounded-full px-4 py-3 mx-3 bg-primary-500 text-white hover:bg-primary-700">
          Search
        </button> */}
        <label htmlFor="file-upload" style={{ cursor: 'pointer' }}>
          <input type="file" id="file-upload" style={{ display: 'none' }} onChange={handleFileChange} />
          <div
            className="flex items-center bg-primary-500 hover:bg-primary-700 px-4 py-2 max-md:px-5 max-md:py-0 h-full rounded-full ml-3 mr-2">
        ...
        {/* <label htmlFor="file-upload" style={{ cursor: 'pointer' }}>
          <input type="file" id="file-upload" style={{ display: 'none' }} onChange={handleFileChange}/>
          <div
            className="flex items-center ml-2 bg-primary-500 hover:bg-primary-700 px-4 py-1.5 rounded-full">
          ...
          <div className="file-popup-content rounded-3xl w-[400px]">
            ...
            <div className="popup-body">
              ...
              <div className="flex flex-row justify-end mt-4 space-x-0">
                ...
                <button onClick={handleFileUpload} className="upload-btn font-bold bg-primary-500 hover:bg-primary-700 text-white px-6 py-2 rounded-full">
                  Upload
                </button>
              </div>
            </div>

...
function OutputData() {
  const user = {
    ...
    text: "Borem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac aliquetodio @Ben mattis.",
    tags: "@Ben is tagged"
  };
  ...
  return (
    ...
    <article className="flex flex-col px-5 pb-2.5 bg-white rounded-2xl shadow-sm max-w-[610px]">
      ...
      <p className="mt-3.5 text-xs font-semibold leading-6 text-blue-500 underline max-md:max-w-full">{user.tags}</p>

...
//             </p>
//             {/* Render attachments */}
//             <div className="flex flex-row flex-nowrap mt-2 gap-2">
//               {post.attachments.map((attachment, index) => (
//                 <div key={index} className="attachment">
//                   {attachment.mime_type.startsWith("image/") ? (
//                     <img src={`/storage/${attachment.path}`} alt="Attachment" className="max-w-full h-auto inline-block" style={{ maxWidth: '100px' }} />
//                   ) : (
//                     <a href={`/storage/${attachment.path}`} target="_blank" rel="noopener noreferrer">
//                       {attachment.path.split("/").pop()}
//                     </a>
...
//               {post.attachments.map((attachment, index) => (
//                 <div key={index} className="attachment" style={{ flexBasis: `calc(${100 / Math.min(post.attachments.length, 3)}% - 8px)` }}>
//                   {attachment.mime_type.startsWith("image/") ? (
//                     <img src={`/storage/${attachment.path}`} alt="Attachment" className="max-w-full h-auto" />
//                   ) : (
//                     <a href={`/storage/${attachment.path}`} target="_blank" rel="noopener noreferrer">

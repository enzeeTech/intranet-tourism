...
function Image({ selectedItem }) { // Receive selectedItem as prop
  ...
  // Check if selectedItem is 'TM Networking Day', if yes, render images
  if (selectedItem === 'TM Networking Day') {
    return (
    ...
    // Otherwise, render placeholder or nothing
    return (
        <section className="flex flex-col px-4 pt-4 py-3 pb-3 max-w-[1500px] max-md:px-5 bg-white rounded-2xl shadow-lg mt-4">
          <header>
            <h1 className="text-2xl font-bold text-neutral-800 max-md:max-w-full pb-2">

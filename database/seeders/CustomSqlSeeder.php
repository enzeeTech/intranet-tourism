...
class CustomSqlSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::transaction(function () {
            $newUserData = base_path('database/migration_data/new_user_data.csv');

            $sql = <<<SQL
            DROP TABLE IF EXISTS new_users_data_offiria;
            ...
            INSERT INTO profiles (user_id, bio, image)
            ...
            SELECT
                ...
                u.id AS user_id,
                COALESCE(n.gred) AS schema_grade,
                n.title AS title,
